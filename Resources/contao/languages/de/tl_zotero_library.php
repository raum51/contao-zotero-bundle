...
$GLOBALS['TL_LANG']['tl_zotero_library'] = [
    ...
    'sync_status_item_creators' => 'Item-Creator-Verknüpfungen: %d neu, %d aktualisiert, %d gelöscht, %d übersprungen',
    ...
    'sync_status_collection_items' => 'Collection-Item-Verknüpfungen: %d neu, %d aktualisiert, %d gelöscht, %d übersprungen',
