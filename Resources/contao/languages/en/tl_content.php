...
$GLOBALS['TL_LANG']['tl_content']['zotero_item'] = ['Zotero single element', 'One publication (fixed or from URL)'];
$GLOBALS['TL_LANG']['tl_content']['zotero_item_mode'] = ['Mode', 'Fixed publication or publication from URL (reader)'];
$GLOBALS['TL_LANG']['tl_content']['zotero_item_mode_options'] = [
    'fixed' => 'Fixed publication',
    'from_url' => 'Publication from URL (reader)',
];
...
$GLOBALS['TL_LANG']['tl_content']['zotero_items'] = ['Zotero publications (single/selected)', 'Display one or more publications'];
$GLOBALS['TL_LANG']['tl_content']['zotero_member_publications'] = ['Member publications', 'All publications linked to this Contao member'];
$GLOBALS['TL_LANG']['tl_content']['zotero_collection_publications'] = ['Collection publications', 'All publications of the selected Zotero collection'];
$GLOBALS['TL_LANG']['tl_content']['zotero_member'] = ['Contao member', 'Member whose publications are displayed'];
$GLOBALS['TL_LANG']['tl_content']['zotero_collection'] = ['Zotero collection', 'Collection whose publications are displayed'];
...
$GLOBALS['TL_LANG']['tl_content']['zotero_member_mode'] = ['Mode', 'Member fixed or from URL (path)'];
$GLOBALS['TL_LANG']['tl_content']['zotero_member_mode_options'] = [
    'fixed' => 'Member fixed',
    'from_url' => 'Member from URL (path) – for member detail pages',
];
$GLOBALS['TL_LANG']['tl_content']['zotero_creator_items_no_publications'] = 'No publications';
...
$GLOBALS['TL_LANG']['tl_content']['zotero_item_types'] = ['Publication types', 'Optional: only show these types (empty = all)'];
...
$GLOBALS['TL_LANG']['tl_content']['zotero_search_show_item_type'] = ['Show publication type filter', 'Publication type dropdown in search form'];
...
$GLOBALS['TL_LANG']['tl_content']['numberOfItems'] = ['Number of publications', 'Number of publications to display (0 = all)'];
$GLOBALS['TL_LANG']['tl_content']['perPage'] = ['Publications per page', 'Number per page for pagination (0 = no pagination)'];
